	...
	class TSSAdmin {
		...
		public function __construct() {
			add_action(
				...
				function () {
					$current = time();
					if ( mktime( 0, 0, 0, 11, 18, 2022 ) <= $current && $current <= mktime( 0, 0, 0, 12, 2, 2022 ) ) {
						if ( '1' !== get_option( 'rttss_bf_2022' ) ) {
							if ( ! isset( $GLOBALS['rt_tss_bf_2022_notice'] ) ) {
								$GLOBALS['rt_tss_bf_2022_notice'] = 'rttss_bf_2022';
								self::notice();
							}
						}
					}
		...
		public static function notice() {
			...
			add_action(
				...
				function () {
					...
					?>
				<div class="notice notice-info is-dismissible" data-rttssdismissable="rttss_bf_2022"
					...
					<p style="margin:0 0 2px;">
						...
						<b><?php echo esc_html( $plugin_name ); ?> plan</b> with <b>UP TO 50% OFF</b>! Limited time offer expires on December 2.
					</p>
